...
we use the TherapyFormats data. This data set is modeled after a real network meta-analysis assessing the effectiveness of different delivery formats of cognitive behavioral therapy for depression [@Cuijpers2019].
...
```{r fig.height= 18, fig.width=15, dpi=400}
